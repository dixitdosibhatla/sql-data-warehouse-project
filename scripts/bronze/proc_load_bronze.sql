...
BEGIN
	...
	BEGIN TRY
		...
		FROM 'C:\path\to\source_crm\cust_info.csv'
		WITH(
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\path\to\source_crm\prd_info.csv'
		WITH(
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\path\to\source_crm\sales_details.csv'
		WITH(
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\path\to\source_erp\CUST_AZ12.csv'
		WITH(
			FORMAT = 'CSV',
			FIRSTROW = 2,
			ROWTERMINATOR = '\n',
		...
		FROM 'C:\path\to\source_erp\LOC_A101.csv'
		WITH(
			FORMAT = 'CSV',
			FIRSTROW = 2,
			ROWTERMINATOR = '\n',
		...
		FROM 'C:\path\to\source_erp\PX_CAT_G1V2.csv'
		WITH(
			FORMAT = 'CSV',
			FIRSTROW = 2,
			ROWTERMINATOR = '\n',
